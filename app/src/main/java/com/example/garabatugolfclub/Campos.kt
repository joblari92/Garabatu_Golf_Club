...
class Campos(val email:String) {
    ...
    //Introduce en la BBDD los valores predeterminados de los campos
    fun crearCampos(){
        db.collection("usuarios").document(email)
            ...
            .set(hashMapOf("par 1" to "5","par 2" to "4","par 3" to "4","par 4" to "4",
                ...
                "hcap 7" to "5","hcap 8" to "13","hcap 9" to "11","hcap 10" to "4",
                "hcap 11" to "10", "hcap 12" to "2","hcap 13" to "8","hcap 14" to "14",
                "hcap 15" to "16","hcap 16" to "6", "hcap 17" to "18","hcap 18" to "12"))
        ...
        db.collection("usuarios").document(email)
            ...
            .set(hashMapOf("par 1" to "5","par 2" to "3","par 3" to "4","par 4" to "4",
                ...
                "hcap 12" to "3","hcap 13" to "9","hcap 14" to "10","hcap 15" to "16",
                "hcap 16" to "14", "hcap 17" to "11","hcap 18" to "12"))
        ...
        db.collection("usuarios").document(email)
            ...
            .set(hashMapOf("par 1" to "5","par 2" to "3","par 3" to "4","par 4" to "4",
                ...
                "hcap 7" to "10","hcap 8" to "17","hcap 9" to "6","hcap 10" to "15",
                "hcap 11" to "11", "hcap 12" to "12","hcap 13" to "4","hcap 14" to "14",
                "hcap 15" to "9","hcap 16" to "3", "hcap 17" to "8","hcap 18" to "7"))
